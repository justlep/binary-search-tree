...
export class AVLTree {
     ...
     * @param {*}        [options.key] Initialize this BST's key with key
     * @param {*}        [options.value] Initialize this BST's data with [value]
     * @param {Function} [options.compareKeys] Initialize this BST's compareKeys
     * @param {Function} [options.checkValueEquality] Initialize this BST's checkValueEquality
     */
    constructor(options = {}) {
...
export class _AVLTree extends BinarySearchTree {
    ...
    // BinarySearchTree's constructor does all we need, no additional one needed here 
